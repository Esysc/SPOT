...
if ($_GET['page'] == "install") {
    ...
    <html lang="en">
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="js/1.2/chosen.css">
            <!-- js -->
            ...
            <script  type="text/javascript" src="js/1.2/chosen.jquery.js"></script>
            ...
            <div class="wrapper">
                ...
                <div class="content_overlay">
                    <div class="container-fluid" id="mainContainer">
                        ...
                        /* password reset required */ elseif ($User->user->passChange == "Yes") {
                            print "<div id='dashboard' class='container'>";
                            include_once("app/tools/pass-change/form.php");
                            print "</div>";
                        }
                        /* dashboard */ elseif (!isset($_GET['page']) || $_GET['page'] == "dashboard") {
                            print "<div id='dashboard'>";
                            include_once("app/dashboard/index.php");
                            print "</div>";
                        }
                        /* widgets */ elseif ($_GET['page'] == "widgets") {
                            print "<div id='dashboard' class='container'>";
                            include_once("app/dashboard/widgets/index.php");
                            print "</div>";
                        }
                        /* all sections */ elseif ($_GET['page'] == "subnets" && strlen($_GET['section']) == 0) {
                            print "<div id='dashboard' class='container'>";
                        ...
                        /* content */ else {
                            ...
                            if (($_GET['page'] == "tools" || $_GET['page'] == "administration") && !isset($_GET['section'])) {
                                ...
                                if ($_GET['page'] == "subnets" || $_GET['page'] == "vlan" ||
                                        $_GET['page'] == "vrf" || $_GET['page'] == "folder") {
                                    include("app/subnets/subnets-menu.php");
                            ...
                            if ($_GET['page'] == "subnets") {
                                if (@$_GET['sPage'] == "address-details") {
                                    include("app/subnets/addresses/address-details-index.php");
                                } elseif (!isset($_GET['subnetId'])) {
                                    include("app/sections/section-subnets.php");
                                } else {
                            ...
                            elseif ($_GET['page'] == "tools") {
                                if (!isset($_GET['section'])) {
                                    ...
                                    if (!in_array($_GET['section'], $tools_menu_items)) {
                                        header("Location: " . create_link("error", "400"));
                                        die();
                                    } elseif (!file_exists("app/tools/$_GET[section]/index.php")) {
                            ...
                            elseif ($_GET['page'] == "administration") {
                                ...
                                if (!isset($_GET['section'])) {
                                    ...
                                    if (!in_array($_GET['section'], $admin_menu_items)) {
                                        header("Location: " . create_link("error", "400"));
                                        die();
