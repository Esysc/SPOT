...
if ($subnet === false) {
    header("Location: " . create_link("subnets", $_GET['section']));
    die();
} //redirect if false
else {
    $subnet = (array) $subnet;
...
if ($subnet['isFolder'] == 1) {
    header("Location: " . create_link("folder", $_GET['section'], $_GET['subnetId']));
}
...
<div class="row" style="margin-bottom: 40px;">
    ...
    if (@$_GET['sPage'] == "changelog") {
        print "col-lg-12 col-md-12";
    } else {
        print "col-lg-8 col-md-8";
    }
    ?>">
