            ...
            if ($perm > 0) {
                ...
                if ($section->masterSection == "0" || empty($section->masterSection)) {
                    ...
                    if (isset($sves)) {
                        ...
                        # section
                        if ($_GET['section'] == $section->id) {
                            print "<li class='active'><a href='" . create_link("subnets", $section->id) . "'>$section->name</a></li>";
                        } else {
                            print "<li>				<a href='" . create_link("subnets", $section->id) . "'>$section->name</a></li>";
                        }
                        ...
                        # subsections
                        foreach ($sves as $sl) {
                            if ($_GET['section'] == $sl->id) {
                                print "<li class='active'><a href='" . create_link("subnets", $sl->id) . "'><i class='fa fa-angle-right'></i> $sl->name</a></li>";
                            } else {
                                print "<li>				<a href='" . create_link("subnets", $sl->id) . "'><i class='fa fa-angle-right'></i> $sl->name</a></li>";
                            }
                        }
...
//check if user has favourite subnets
    ...
    # get all subnet request

    if (isset($subnetRequests)) {
        ?>

        <li>
            <a href="<?php print create_link("tools", "subnetRequests"); ?>" rel='tooltip' class="icon-li btn-info" data-placement='bottom' title="<?php print $subnetRequests . " " . _('subnetRequests') . " " . _('for subnet waiting for your approval'); ?>"><i class='fa fa-envelope-o' style="padding-right:2px;"></i><sup><?php print $subnetRequests; ?></sup></a>
        </li>
        <?php
    }
    ...
    if (isset($subnetDismiss)) {
        ...
        <li>
            <a href="<?php print create_link("tools", "subnetDismiss"); ?>" rel='tooltip' class="icon-li btn-danger" data-placement='bottom' title="<?php print $subnetDismiss . " " . _('subnetDismiss') . " " . _('for subnet dismission waiting for your approval'); ?>"><i class='fa fa-envelope-o' style="padding-right:2px;"></i><sup><?php print $subnetDismiss; ?></sup></a>
        </li>
        <?php
    }
