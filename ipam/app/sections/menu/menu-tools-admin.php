...
<?php } ?>
    ...
    <!-- tools -->
    <li class="tools dropdown <?php if (@$_GET['page'] == "tools") {
    print " ac1tive";
} ?>">
...
# get all subnet request
    ...
    if (isset($subnetRequests)) {
        ...
        <li>
            <a href="<?php print create_link("tools", "subnetRequests"); ?>" rel='tooltip' class="icon-li btn-info" data-placement='bottom' title="<?php print $subnetRequests . " " . _('subnet requests') . " " . _('for subnet waiting for your approval'); ?>"><i class='fa fa-envelope-o' style="padding-right:2px;"></i><sup><?php print $subnetRequests; ?></sup></a>
        </li>
        <?php
    }
