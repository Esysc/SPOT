...
<?php
/**
 * Script to get all active Dismiss requests
 * ************************************** */
...
<h4><?php print _('List of  dismiss requests'); ?></h4>
<hr><br>

<?php
if ($subnetDismiss != false) {
    print "<div class='alert alert-info'>" . _('List of unprocessed dismiss requests') . "</div>\n";
    ?>
<div  id="dismissSubnet"  class="divTable">
...
<div class="divTableBody">
            ...
            <?php
            # print requests
            foreach ($subnetDismiss as $k => $request) {
                //cast
...
<hr><br>
    ...
    print "<div class='alert alert-success'>" . _('No active dimsiss requests available') . '!</div>';
}
$subnetDismiss = $Tools->fetch_multiple_objects("subnetDismiss", "processed", 1, "id", false);
if ($subnetDismiss != false) {

    print "<div class='alert alert-info'>" . _('List of processed dismiss requests') . '</div>';
    ?>
    ...
    print "<div class='alert alert-success'>" . _('No processed dismiss requests available') . "!</div>";
}
