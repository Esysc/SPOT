...
class Sections_controller extends Common_api_functions {
    ...
    public function POST() {
        ...
        if (isset($this->_params->masterSection)) {
            ...
            // checks
            if (sizeof($masterSection) == 0) {
                $this->Response->throw_exception(400, 'Invalid masterSection id ' . $this->_params->masterSection);
            } elseif ($masterSection->masterSection != "0") {
                $this->Response->throw_exception(400, 'Only 1 level of nesting is permitted for sections');
            }
        }
    ...
    public function PATCH() {
        ...
        if (!isset($this->_params->id)) {
            $this->Response->throw_exception(400, "Section Id required");
        }
