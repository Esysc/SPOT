...
function create_link($l0 = null, $l1 = null, $l2 = null, $l3 = null, $l4 = null, $l5 = null, $l6 = null) {
    ...
    # normal
        ...
        if (!is_null($l6)) {
            $link = "?$el[0]=$l0&$el[1]=$l1&$el[2]=$l2&$el[3]=$l3&$el[4]=$l4&$el[5]=$l5&$el[6]=$l6";
        } elseif (!is_null($l5)) {
            $link = "?$el[0]=$l0&$el[1]=$l1&$el[2]=$l2&$el[3]=$l3&$el[4]=$l4&$el[5]=$l5";
        } elseif (!is_null($l4)) {
            $link = "?$el[0]=$l0&$el[1]=$l1&$el[2]=$l2&$el[3]=$l3&$el[4]=$l4";
        } elseif (!is_null($l3)) {
            $link = "?$el[0]=$l0&$el[1]=$l1&$el[2]=$l2&$el[3]=$l3";
        } elseif (!is_null($l2)) {
            $link = "?$el[0]=$l0&$el[1]=$l1&$el[2]=$l2";
        } elseif (!is_null($l1)) {
            $link = "?$el[0]=$l0&$el[1]=$l1";
        } elseif (!is_null($l0)) {
            $link = "?$el[0]=$l0";
        } else {
            $link = "";
...
function sanitize($in) {
    return addslashes(htmlspecialchars(strip_tags(trim(str_replace("'", "", str_replace('"', '', $in))))));
}
