...
<script>
    $(document).ready(function () {
        ...
        $('#salesel').on('change', function (e) {
            ...
            tdEle.append(extLink).trigger('click');
            $(this).remove();
...
//Ready to set attributes to  Sysprod DB
        ...
        $(document).on('click', '#addRow', function (e) {
            ...
            $('.delRow').remove();
            e.preventDefault();
            $(this).closest('tr').before('<tr><td><label>Subnet</label><input type="text" ui="Subnet used" id="subnet_' + counter + '" class="subnet required" name="network" placeholder="Subnet used" data-attr="' + counter + '"/></td><td><label>Netmask</label><select class="chosen" name="netmask" data-attr="' + counter + '"><option selected value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option></select></td><td><label>Network name</label><select class="chosen" name="network_name" id="row' + counter + '" data-attr="' + counter + '" required><option value="10<>CTRL">CTRL vlan 10</option><option value="20<>ENTT">ENTT vlan 20</option><option value="30<>DRUM">DRUM vlan 30</option><option value="70<>BUSINESS-ML">BUSINESS-ML vlan 70</option><option value="100<>MGMT">MGMT vlan 100</option></select><a href="#" class="btn btn-action delRow pull-right"><i class="icon-minus-sign icon-white"></i> Remove this entry</a></td></tr>');
            $('.chosen').chosen();
        });
        ...
        <tr id="first">
            ...
            <td>
                ...
                <select class="chosen" name="network_name"  data-attr="0">
                    ...
                    <option value="20<>ENTT">ENTT vlan 20</option>
                    <option value="10<>DRUM">DRUM vlan 30</option>
