...
require_once("DAO/EventcategoryCriteriaDAO.php");

/**
 * The EventcategoryCriteria class extends EventcategoryDAOCriteria and is used
 ...
 * @version 1.0
 */
class EventcategoryCriteria extends EventcategoryCriteriaDAO
{
