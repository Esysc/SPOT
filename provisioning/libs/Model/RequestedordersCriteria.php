...
require_once("DAO/RequestedordersCriteriaDAO.php");

/**
 * The RequestedordersCriteria class extends RequestedordersDAOCriteria and is used
 ...
 * @version 1.0
 */
class RequestedordersCriteria extends RequestedordersCriteriaDAO
{
