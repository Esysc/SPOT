...
require_once("DAO/ConfigtemplateCriteriaDAO.php");

/**
 * The ConfigtemplateCriteria class extends ConfigtemplateDAOCriteria and is used
 ...
 * @version 1.0
 */
class ConfigtemplateCriteria extends ConfigtemplateCriteriaDAO
{
