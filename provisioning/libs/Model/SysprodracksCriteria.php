...
require_once("DAO/SysprodracksCriteriaDAO.php");

/**
 * The SysprodracksCriteria class extends SysprodracksDAOCriteria and is used
 ...
 * @version 1.0
 */
class SysprodracksCriteria extends SysprodracksCriteriaDAO
{
