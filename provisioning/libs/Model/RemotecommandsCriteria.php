...
require_once("DAO/RemotecommandsCriteriaDAO.php");

/**
 * The RemotecommandsCriteria class extends RemotecommandsDAOCriteria and is used
 ...
 * @version 1.0
 */
class RemotecommandsCriteria extends RemotecommandsCriteriaDAO
{
