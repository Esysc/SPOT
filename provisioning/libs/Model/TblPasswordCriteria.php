...
require_once("DAO/TblPasswordCriteriaDAO.php");

/**
 * The TblPasswordCriteria class extends TblPasswordDAOCriteria and is used
 ...
 * @version 1.0
 */
class TblPasswordCriteria extends TblPasswordCriteriaDAO
{
