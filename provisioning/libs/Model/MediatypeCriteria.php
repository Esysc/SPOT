...
require_once("DAO/MediatypeCriteriaDAO.php");

/**
 * The MediatypeCriteria class extends MediatypeDAOCriteria and is used
 ...
 * @version 1.0
 */
class MediatypeCriteria extends MediatypeCriteriaDAO
{
