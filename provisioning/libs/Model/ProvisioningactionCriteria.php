...
require_once("DAO/ProvisioningactionCriteriaDAO.php");

/**
 * The ProvisioningactionCriteria class extends ProvisioningactionDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProvisioningactionCriteria extends ProvisioningactionCriteriaDAO
{
