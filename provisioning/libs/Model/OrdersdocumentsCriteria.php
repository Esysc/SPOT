...
require_once("DAO/OrdersdocumentsCriteriaDAO.php");

/**
 * The OrdersdocumentsCriteria class extends OrdersdocumentsDAOCriteria and is used
 ...
 * @version 1.0
 */
class OrdersdocumentsCriteria extends OrdersdocumentsCriteriaDAO
{
