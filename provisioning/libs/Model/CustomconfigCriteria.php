...
require_once("DAO/CustomconfigCriteriaDAO.php");

/**
 * The CustomconfigCriteria class extends CustomconfigDAOCriteria and is used
 ...
 * @version 1.0
 */
class CustomconfigCriteria extends CustomconfigCriteriaDAO
{
