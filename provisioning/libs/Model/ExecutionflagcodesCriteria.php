...
require_once("DAO/ExecutionflagcodesCriteriaDAO.php");

/**
 * The ExecutionflagcodesCriteria class extends ExecutionflagcodesDAOCriteria and is used
 ...
 * @version 1.0
 */
class ExecutionflagcodesCriteria extends ExecutionflagcodesCriteriaDAO
{
