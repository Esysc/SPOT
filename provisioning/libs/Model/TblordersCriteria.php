...
require_once("DAO/TblordersCriteriaDAO.php");

/**
 * The TblordersCriteria class extends TblordersDAOCriteria and is used
 ...
 * @version 1.0
 */
class TblordersCriteria extends TblordersCriteriaDAO
{
