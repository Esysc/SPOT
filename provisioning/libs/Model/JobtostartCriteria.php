...
require_once("DAO/JobtostartCriteriaDAO.php");

/**
 * The JobtostartCriteria class extends JobtostartDAOCriteria and is used
 ...
 * @version 1.0
 */
class JobtostartCriteria extends JobtostartCriteriaDAO
{
