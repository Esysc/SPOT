...
require_once("DAO/DhcpbootpinvCriteriaDAO.php");

/**
 * The DhcpbootpinvCriteria class extends DhcpbootpinvDAOCriteria and is used
 ...
 * @version 1.0
 */
class DhcpbootpinvCriteria extends DhcpbootpinvCriteriaDAO
{
