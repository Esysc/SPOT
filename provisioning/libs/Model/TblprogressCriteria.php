...
require_once("DAO/TblprogressCriteriaDAO.php");

/**
 * The TblprogressCriteria class extends TblprogressDAOCriteria and is used
 ...
 * @version 1.0
 */
class TblprogressCriteria extends TblprogressCriteriaDAO
{
