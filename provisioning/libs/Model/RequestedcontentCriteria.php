...
require_once("DAO/RequestedcontentCriteriaDAO.php");

/**
 * The RequestedcontentCriteria class extends RequestedcontentDAOCriteria and is used
 ...
 * @version 1.0
 */
class RequestedcontentCriteria extends RequestedcontentCriteriaDAO
{
