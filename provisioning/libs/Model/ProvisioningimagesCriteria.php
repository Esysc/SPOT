...
require_once("DAO/ProvisioningimagesCriteriaDAO.php");

/**
 * The ProvisioningimagesCriteria class extends ProvisioningimagesDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProvisioningimagesCriteria extends ProvisioningimagesCriteriaDAO
{
