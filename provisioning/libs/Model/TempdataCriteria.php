...
require_once("DAO/TempdataCriteriaDAO.php");

/**
 * The TempdataCriteria class extends TempdataDAOCriteria and is used
 ...
 * @version 1.0
 */
class TempdataCriteria extends TempdataCriteriaDAO
{
