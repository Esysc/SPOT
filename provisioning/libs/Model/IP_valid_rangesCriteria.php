...
require_once("DAO/IP_valid_rangesCriteriaDAO.php");

/**
 * The IP_valid_rangesCriteria class extends IP_valid_rangesDAOCriteria and is used
 ...
 * @version 1.0
 */
class IP_valid_rangesCriteria extends IP_valid_rangesCriteriaDAO
{
