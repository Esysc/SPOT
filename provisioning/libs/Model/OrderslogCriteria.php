...
require_once("DAO/OrderslogCriteriaDAO.php");

/**
 * The OrderslogCriteria class extends OrderslogDAOCriteria and is used
 ...
 * @version 1.0
 */
class OrderslogCriteria extends OrderslogCriteriaDAO
{
