...
require_once("DAO/ProvisioningCriteriaDAO.php");

/**
 * The ProvisioningCriteria class extends ProvisioningDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProvisioningCriteria extends ProvisioningCriteriaDAO
{
