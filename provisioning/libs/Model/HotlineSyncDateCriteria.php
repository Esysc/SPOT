...
require_once("DAO/HotlineSyncDateCriteriaDAO.php");

/**
 * The HotlineSyncDateCriteria class extends HotlineSyncDateDAOCriteria and is used
 ...
 * @version 1.0
 */
class HotlineSyncDateCriteria extends HotlineSyncDateCriteriaDAO
{
