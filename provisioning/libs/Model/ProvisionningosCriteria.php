...
require_once("DAO/ProvisionningosCriteriaDAO.php");

/**
 * The ProvisionningosCriteria class extends ProvisionningosDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProvisionningosCriteria extends ProvisionningosCriteriaDAO
{
