...
require_once("DAO/NetworksCriteriaDAO.php");

/**
 * The NetworksCriteria class extends NetworksDAOCriteria and is used
 ...
 * @version 1.0
 */
class NetworksCriteria extends NetworksCriteriaDAO
{
