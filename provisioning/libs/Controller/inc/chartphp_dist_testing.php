...
if (!empty($_POST["pngdata"])) {
    ...
    if (empty($title))
        $title = rand(2345, 9999);
    if ($V599dcce2998a6b40b1e38e8c6006cb == "pdf") {
        require_once('tcpdf/tcpdf.php');
        $V437175ba4191210ee004e1d937494d = new TCPDF("L", PDF_UNIT, "a6", true, 'UTF-8', false);
        ...
        $V563728df0fdd90631ac1e51258e285 = getimagesize($data);
        $width = $V563728df0fdd90631ac1e51258e285[0];
        $V437175ba4191210ee004e1d937494d->setJPEGQuality(100);
        $V437175ba4191210ee004e1d937494d->setImageScale($width / 346);
...
class chartphp {
    ...
    function render($Vb80bb7740288fda1f201890375a60c) {
        ...
        $this->V93da65a9fd0004d9477aeac024e08e["title"]["fontSize"] = "20px";
        ...
        $this->V93da65a9fd0004d9477aeac024e08e["animate"] = false;
        $this->V93da65a9fd0004d9477aeac024e08e["grid"]["backgroundColor"] = "white";
        $this->V93da65a9fd0004d9477aeac024e08e["grid"]["borderWidth"] = 1;
        $this->V93da65a9fd0004d9477aeac024e08e["grid"]["shadow"] = false;
        $this->V93da65a9fd0004d9477aeac024e08e["grid"]["borderColor"] = "#B3B3B3";
        $this->V93da65a9fd0004d9477aeac024e08e["grid"]["drawBorder"] = false;
        $this->V93da65a9fd0004d9477aeac024e08e["grid"]["drawGridlines"] = true;
        $this->V93da65a9fd0004d9477aeac024e08e["grid"]["gridLineColor"] = "#E8E8E8";
        $this->V93da65a9fd0004d9477aeac024e08e["legend"]["show"] = false;
        $this->V93da65a9fd0004d9477aeac024e08e["legend"]["textColor"] = "black";
        $this->V93da65a9fd0004d9477aeac024e08e["legend"]["fontFamily"] = "Arial";
        $this->V93da65a9fd0004d9477aeac024e08e["legend"]["placement"] = "inside";
        ...
        $this->V93da65a9fd0004d9477aeac024e08e["axes"]["yaxis"]["pad"] = 1.1;
        ...
        if ($this->chart_type == "area") {
            ...
            $this->V93da65a9fd0004d9477aeac024e08e["seriesDefaults"][shadowAlpha] = 0.1;
            $this->V93da65a9fd0004d9477aeac024e08e["seriesDefaults"][rendererOptions][showLabels] = true;
            $this->V93da65a9fd0004d9477aeac024e08e["seriesDefaults"][rendererOptions][bubbleGradients] = true;
            ...
            $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["renderer"] = "$.jqplot.CategoryAxisRenderer";
            $this->V93da65a9fd0004d9477aeac024e08e["highlighter"]["show"] = false;
            $this->V93da65a9fd0004d9477aeac024e08e["seriesColors"] = array("#1AAF5D", "#F2C500", "#F45B00", "#8E0000", "#0E948C");
        } else if ($this->chart_type == "bar-stacked") {
            $Vf644bb32e0243d906e4a187b6b00d2 = array();
            if (!empty($this->series_label) && $this->chart_type == "bar-stacked") {
            ...
            if ($this->direction == "horizontal") {
                ...
                $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["min"] = 0;
            } else {
                $this->V93da65a9fd0004d9477aeac024e08e["seriesDefaults"]["rendererOptions"]["barDirection"] = 'vertical';
                $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["renderer"] = "$.jqplot.CategoryAxisRenderer";
            ...
            $this->V93da65a9fd0004d9477aeac024e08e["seriesDefaults"]["renderer"] = "$.jqplot.FunnelRenderer";
            $this->V93da65a9fd0004d9477aeac024e08e["seriesDefaults"]["rendererOptions"]["datalabels"] = "percent";
            $this->V93da65a9fd0004d9477aeac024e08e["seriesDefaults"]["rendererOptions"]["showDataLabels"] = true;
            $this->V93da65a9fd0004d9477aeac024e08e["legend"]["show"] = true;
            $this->V93da65a9fd0004d9477aeac024e08e["legend"]["location"] = 'e';
            ...
            $V47c80780ab608cc046f2a6e6f071fe = $V3a2d7564baee79182ebc7b65084aab->GetRows();
            if (in_array($this->chart_type, array('bar-stacked'))) {

                $Vb4a88417b3d0170d754c647c30b721 = array();
                $V48484a39612824059f2e51d0669146 = array();
                $V865c0c0b4ab0e063e5caa3387c1a87 = 0;
                
                foreach ($V47c80780ab608cc046f2a6e6f071fe as $V8277e0910d750195b448797616e091) {
                   
                    $Vb4a88417b3d0170d754c647c30b721[0][$V865c0c0b4ab0e063e5caa3387c1a87] = intval($V8277e0910d750195b448797616e091[1]);
                    $Vb4a88417b3d0170d754c647c30b721[1][$V865c0c0b4ab0e063e5caa3387c1a87] = intval($V8277e0910d750195b448797616e091[2]);
                    $Vb4a88417b3d0170d754c647c30b721[2][$V865c0c0b4ab0e063e5caa3387c1a87] = intval($V8277e0910d750195b448797616e091[3]);
                    $Vb4a88417b3d0170d754c647c30b721[3][$V865c0c0b4ab0e063e5caa3387c1a87] = intval($V8277e0910d750195b448797616e091[4]);
                   
                    $V48484a39612824059f2e51d0669146[] = $V8277e0910d750195b448797616e091[0];
                    $V865c0c0b4ab0e063e5caa3387c1a87++;
                } if ($this->direction == "horizontal")
                    $this->V93da65a9fd0004d9477aeac024e08e["axes"]["yaxis"]["ticks"] = $V48484a39612824059f2e51d0669146;
                else
                    $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["ticks"] = $V48484a39612824059f2e51d0669146;
                $this->data = $Vb4a88417b3d0170d754c647c30b721;
            } else if (in_array($this->chart_type, array('bubble'))) {
                $Vb4a88417b3d0170d754c647c30b721 = array();
                foreach ($V47c80780ab608cc046f2a6e6f071fe as $V8277e0910d750195b448797616e091) {
                    ...
                    if (is_numeric($V8277e0910d750195b448797616e091[2]))
                        $V8277e0910d750195b448797616e091[2] = floatval($V8277e0910d750195b448797616e091[2]);
                    if (is_numeric($V8277e0910d750195b448797616e091[3]))
                        $V8277e0910d750195b448797616e091[3] = floatval($V8277e0910d750195b448797616e091[3]);
                    $Vb4a88417b3d0170d754c647c30b721[] = array($V8277e0910d750195b448797616e091[0], $V8277e0910d750195b448797616e091[1], $V8277e0910d750195b448797616e091[2], $V8277e0910d750195b448797616e091[3]);
                ...
                foreach ($V47c80780ab608cc046f2a6e6f071fe as $V8277e0910d750195b448797616e091) {
                    ...
                    if (is_numeric($V8277e0910d750195b448797616e091[1]))
                        $V8277e0910d750195b448797616e091[1] = floatval($V8277e0910d750195b448797616e091[1]);
                    $Vb4a88417b3d0170d754c647c30b721[] = array($V8277e0910d750195b448797616e091[0], $V8277e0910d750195b448797616e091[1]);
                    if ($V8277e0910d750195b448797616e091[1] > $V2ffe4e77325d9a7152f7086ea7aa51)
                        $V2ffe4e77325d9a7152f7086ea7aa51 = $V8277e0910d750195b448797616e091[1];
                } $this->data = array($Vb4a88417b3d0170d754c647c30b721);
            }
        } if (isset($this->x_data_type) && $this->x_data_type == "date") {
            $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["renderer"] = "$.jqplot.DateAxisRenderer";
            $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["tickOptions"]["formatString"] = '%b %Y';
            if (count($this->data[0]) >= 10)
                $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["numberTicks"] = 10;
        } else {
            if (count($this->data[0]) >= 10)
                $this->V93da65a9fd0004d9477aeac024e08e["axes"]["xaxis"]["numberTicks"] = 20;
        ...
        <div style="position:relative;">    
            <?php if ($this->Vb2507468f95156358fa490fd543ad2 == true) { ?>  
                ...
                <div id="<?php echo $Vb80bb7740288fda1f201890375a60c ?>_export" style="display:none; position:absolute; right:0px; z-index:99999;">  


                    <img src="images/download.png" alt="Export" onclick="$(this).next().toggle();"> 
                    <div class="export_option" style="position:absolute; margin-top:5px; right:0px; display:none; width:25px;">  
                        <img style="margin-bottom:5px;" src="images/jpeg-icon.png" alt="JPEG" onclick="F91a412c16e2ed2e8ff99062ad09aa7($('#<?php echo $Vb80bb7740288fda1f201890375a60c ?>'), 'jpg', '<?php echo $this->title ?>')"> 
                        <img src="images/pdf-icon.png" alt="PDF" onclick="F91a412c16e2ed2e8ff99062ad09aa7($('#<?php echo $Vb80bb7740288fda1f201890375a60c ?>'), 'jpg-pdf', '<?php echo $this->title ?>')"> 
                    </div>  
                </div> 
                <div style="display:none"> 
                    <form action="" method="post" accept-charset="utf-8" id="imgform"> 
                        <input name="imgtype" id="imgtype">  <input name="imgtitle" id="imgtitle">  
                        <textarea class="display-none" rows="10" cols="10" name="pngdata" id="pngdata"> 
                        </textarea>  </form>  </div>  <?php } ?>    <div id="<?php echo $Vb80bb7740288fda1f201890375a60c ?>" style="height:<?php echo $this->height ?>; width:<?php echo $this->width ?>;">
            </div> 
        </div> 
        <script>
