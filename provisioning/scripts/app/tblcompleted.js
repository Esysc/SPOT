...
var page = {
    ...
    filterComplete: function () {
         ...
         * Only the records that are  completely provisioned are showed. this hacks permits the utilisation of the same 
    ...
    chooseAndReloadOrder: function () {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {salesorder: $('input#salesorder').val(),
                data: $('textarea#data').val()
            },
            wait: true,
            success: function () {
                $('#tblprogressDetailDialog').modal('hide');
                // $('#success').html('Successfully selected sales order  ' + $('input#salesorder').val() + '  for further provisioning. You can now proceed to provision the machines:  <a href=\"./reload\" class=\"btn btn-large btn-primary\">Wizard');
                // $('#failed').hide();
                //$('#success').show();
                $('#servermsg').html('Successfully reloaded sales order <strong> ' + $('input#salesorder').val() + ' </strong>for provisioning. You can now proceed to provision the machines:  <a href=\"./reload\" class=\"btn btn-info btn-mini\">Wizard');
                $('#basicModal').modal();
            },
