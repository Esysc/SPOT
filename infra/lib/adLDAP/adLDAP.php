...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = ACCOUNT_SUFFIX;
    ...
    * @var array
    */
    protected $domainControllers = array(DOMAIN_CONTROLLERS);
    ...
    * @var string
    */
	protected $adminUsername = AD_USERNAME;
    protected $adminPassword = AD_PASSWORD;
